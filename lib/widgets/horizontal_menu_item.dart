                    ...
                    child: Row(
                      children: [
                       ...
                       SizedBox(width:_width / 88),
                        ...
                        Flexible(child: CustomText(text: itemName , color: menuController.isHovering(itemName) ? dark : lightGrey, size: 15, weight: FontWeight.w900))
                        else
                        Flexible(child: CustomText(text: itemName , color:blue , size:15, weight: FontWeight.bold,))
