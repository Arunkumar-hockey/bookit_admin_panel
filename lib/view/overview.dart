...
import 'package:admin_panel/widgets/driverbarchart.dart';
import 'package:admin_panel/widgets/revenuebarchart.dart';
import 'package:admin_panel/widgets/custom_text.dart';
import 'package:admin_panel/widgets/info_card.dart';
import 'package:admin_panel/widgets/info_card_small.dart';
import 'package:admin_panel/widgets/revenue_info.dart';
import 'package:admin_panel/widgets/userbarchart.dart';
import 'package:admin_panel/widgets/userinfo.dart';
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                    width: 600,
                    height: 200,
                    child: RevenueBarChart.withSampleData()),
              ],
            ),
          ),
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                    width: 600,
                    height: 200,
                    child: UserBarChart.withSampleData()),
              ],
            ),
          ),
          Container(
      ...
      child: Column(
        ...
        children: [
          ...
          DataTable2(
              ...
              rows: availabledriersinfo.map((e) =>DataRow(cells: [
                        DataCell(CustomText(
                          text: (e["id"]),
